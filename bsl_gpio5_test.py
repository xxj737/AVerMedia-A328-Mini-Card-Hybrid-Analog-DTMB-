...
print('reg0 now =', hex(rd(0x00)) if rd(0x00) is not None else None)
print('GPIO5 LOW (reset assert)'); wr('0x105018','0x20'); time.sleep(0.3)
print('GPIO5 HIGH (release)'); wr('0x105014','0x20'); time.sleep(0.5)
print('after pulse reg0 =', hex(rd(0x00)) if rd(0x00) is not None else None)
