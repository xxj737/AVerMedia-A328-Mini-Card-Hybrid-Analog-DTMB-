 ...
 * This BSL array comes from the AVerMedia A328 (1461:8323) driver package.
 *
...
{
	/* A328 (AVerMedia 1461:8323): single BSL image. */
 ...
 * so probe is never invoked for non-BlackGold cards (e.g. AVerMedia A328
 * 1461:8323). 0xffff = PCI_ANY_ID = real wildcard. */
